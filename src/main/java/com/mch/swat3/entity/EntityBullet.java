...
public abstract class EntityBullet extends Entity implements IProjectile
{
    ...
    public EntityBullet.PickupStatus pickupStatus;
    ...
    public EntityBullet(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityBullet.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    /**
     * Similar to setbulletHeading, it's point the throwable entity to a x, y, z direction.
     */
        ...
        if (entity != null)
        {
            ...
            if (entity.attackEntityFrom(damagesource, (float)i))
            {
                if (entity instanceof EntityLivingBase)
                {
                    ...
                    {
                    	//render blood on player here 
                    	/*
                        entitylivingbase.setbulletCountInEntity(entitylivingbase.getbulletCountInEntity() + 1);
                        */
                    }
                ...
                this.playSound(SoundEvents.BLOCK_GRAVEL_HIT, 1.0F, 2.0F / (this.rand.nextFloat() * 0.2F + 0.9F));
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityBullet.PickupStatus.ALLOWED)
                    {
    ...
    {
        Entity entity = null;
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expandXyz(1.0D), bullet_TARGETS);
        double d0 = 0.0D;
    ...
    {
        func_189657_a(p_189658_0_, "bullet");
    }
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        compound.setByte("shake", (byte)this.bulletShake);
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        this.bulletShake = compound.getByte("shake") & 255;
        ...
        {
            this.pickupStatus = EntityBullet.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityBullet.PickupStatus.ALLOWED : EntityBullet.PickupStatus.DISALLOWED;
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityBullet.PickupStatus.ALLOWED || this.pickupStatus == EntityBullet.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityBullet.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getbulletStack()))
            {
                flag = false;
            }
    ...
    /**
     * Whether the bullet has a stream of critical hit particles flying behind it.
     */
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityBullet.PickupStatus getByOrdinal(int ordinal)
        {
